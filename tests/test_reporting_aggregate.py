import json
from debatesc.reporting.aggregate import aggregate_results, flatten_metrics
from debatesc.reporting.tables import write_tables
from debatesc.reporting.figures import write_caption, write_figures
