...
This note situates **Do Debate Models Learn Human Spot-Check Habits** against the mentor-linked literature for
[Do Debate Models Learn Human Spot-Check Habits](https://github.com/alanasung/debate-spotcheck).

## Positioning

Test whether debate setups let models learn and exploit human spot-checking patterns.

The design hypothesis is: Test whether debate setups let models learn and exploit human spot-checking patterns.
