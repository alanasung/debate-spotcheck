...
def _registered_builder(name: str):
    ...
    try:
        module = importlib.import_module("debatesc.data")
...
def main(argv: list[str] | None = None) -> int:
    ...
    from debatesc.utils.run_manifest import utc_now_iso, write_json_atomic
    ...
    if builder is not None:
        ...
        source = f"debatesc.data.BUILDERS[{data.name!r}]"
        ...
        print(
            ...
            "src/debatesc/data/__init__.py under BUILDERS, or use data=synthetic "
