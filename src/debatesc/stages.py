"""Experiment stages for Do Debate Models Learn Human Spot-Check Habits."""
...
from .debatesc._util import ensure_dir, stage_result, write_json
...
def stage_report(cfg: DictConfig, run_dir: Path) -> dict[str, Any]:
    ...
    write_json(out / "report.json", {"headline": "Do Debate Models Learn Human Spot-Check Habits", "claims_gated": True})
